...
- [ ] D62.3: Fix code duplication of getLangPairFromPath function — The getLangPairFromPath helper function is defined identically in both apps/mobile/lib/dictionaryDb.ts:11 and apps/mobile/hooks/useLookup.ts:10. Extract this function to a shared utility file (e.g., apps/mobile/lib/pathUtils.ts) and import it from both locations to avoid duplication and ensure consistency.
