...
- [ ] T21.3: Update `apps/mobile/db/schema.ts` — change `installed_dictionaries`'s primary key to `(source_lang, target_lang, version)` and add a `version TEXT NOT NULL` column, per `SPEC.md`'s "Dictionary Versioning" section
